...
const Perfil = ({ profile: { profile, loading }, getProfileById, user, createChat }) => {
  const { id } = useParams();
    ...
    <section className='container'>
      ...
      <div className='profile-header'>
        ...
        <div className='profile-info'>
          ...
          <p>{profile.titulo}</p>
          <br/>
          <p>Pasea en {profile.direccion.localidad}</p>
        </div>
...
export default connect(mapStateToProps, { getProfileById, createChat })(Perfil);
